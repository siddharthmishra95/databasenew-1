        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="tab">
                        <button class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">2022 Data</button>
                    ...
                    <div id="London" class="tabcontent">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">2022 MIS Candidate Details</h4>
                    ...
                    <div id="Paris" class="tabcontent">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">2021 MIS Candidate Details</h4>
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <div>
                                                <!-- Custom Filter -->
                                                <table>
                                                    <h4 class="text-center text-info">Your Search Query</h4>
                                                    <hr>
                                                    </hr>
                                                    <tr>
                    ...
                    <div id="Tokyo" class="tabcontent">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">2020 MIS Candidate Details</h4>
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <div>
