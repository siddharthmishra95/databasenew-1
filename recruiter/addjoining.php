                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" name="datoffer" value="<?= $datoffer;  ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="month" name="month" value="<?= $month;  ?>"
                                                    class="form-control" placeholder="Month Offer" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="uploaded" value="<?= $_SESSION['name'];  ?>"
                                                    class="form-control" placeholder="uploaded" required=""
                                                    readonly="readonly">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="selectedcomp" value="<?= $selectedcomp ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="contactper" value="<?= $contactper;  ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="precomp" value="<?= $precomp;  ?>"
                                                    class="form-control" placeholder="Previous Company" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="currentadd" value="<?= $currentadd;  ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="peradd" value="<?= $peradd;  ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Date Offer</label>
                                            <div class="col-sm-8">
                                                <input type="date" id="datoffer" name="datoffer"
                                                    value="<?= $datoffer;  ?>" required=""
                                                    class="form-group form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Employee</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="uploaded" name="uploaded"
                                                    value="<?= $uploaded ?>" class="form-control" placeholder="uploaded"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Employee Code</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="empid" name="empid" value="<?php $empid ?>"
                                                    class="form-control" required="" readonly="readonly">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input type="text" id="candidatename" name="candidatename"
                                                    value="<?= $candidatename;  ?>" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Selected Company</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="selectedcomp" name="selectedcomp"
                                                    value="<?= $selectedcomp ?>" class="form-control" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Contact Person</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="contactper" name="contactper"
                                                    value="<?= $contactper;  ?>" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Previous Company</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="precomp" name="precomp" value="<?= $precomp;  ?>"
                                                    class="form-control" placeholder="Previous Company" required="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Date Of Joining</label>
                                            <div class="col-sm-8">
                                                <input type="date" id="doj" name="doj" value="<?= $doj;  ?>"
                                                    class="form-control" placeholder="Date Of Joining" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Current Address</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="currentadd" name="currentadd"
                                                    value="<?= $currentadd;  ?>" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Permanent Address</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="peradd" name="peradd" value="<?= $peradd;  ?>"
                                                    class="form-control" placeholder="Permanent Address" required="">
                                            </div>
                                        </div>
                                    </div>
