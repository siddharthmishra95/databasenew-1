                      ...
                      <table id="example" class="table table-striped table-bordered display responsive nowrap"
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="details.php?details=<?= $row['id']; ?>" class="btn btn-primary p-2"><i
                                  class="fa fa-eye"></i>Details</a>|
                              <a href="../edit.php?edit=<?= $row['id']; ?>" class="btn btn-success p-2"><i
                                  class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>
                              <a href="shortlist.php?shortlist=<?= $row['id']; ?>" class="btn btn-info p-2"><i
                              ...
                              <a href="<?php echo $row['resume']; ?>"
                                ...
                                class="btn btn-danger p-2"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                              <a href="in.php?in=<?= $row['id']; ?>" class="btn btn-secondary p-2"><i
